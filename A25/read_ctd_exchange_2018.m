function read_ctd_exchange_2018(directory, outputfname)
%
...
%
% OVIDE 2018 has depth field inbetween temperature and salinity
%
%
if nargin < 1
...
for i = 1:N
    ...
    [punit, r0] = strtok(uline, ',');
    [dumbunit, r1] = strtok(r0, ','); % skip depth
    [tunit, r2] = strtok(r1, ',');
    [sunit, r3] = strtok(r2, ',');
    ounit = strtok(r3, ',');
