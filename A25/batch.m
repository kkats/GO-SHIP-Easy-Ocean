...
DIR = 'A25/';
fname = 'a25';
years = {'1997', '2002', '2004', '2006', '2008', '2010', '2018'};
ll_grid = [316.6:0.1:350.6];
pr_grid = [0:10:6500];
depth_files = {'', '', '', '', '', '', ''};
...
for n = 1:length(years)
    ...
    if ~exist(mfile)
        if n == 2 || n == 3 || n == 5
            com = ['addpath A25; read_ctd_exchange_OVIDE(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath A25'];
        elseif n == 4
            com = ['addpath A25; read_NetCDF_OVIDE(''' PREFIX 'CTD/' DIR years{n} '/ovide_2006_CTDO2.nc'', ''06MM20060523'', ''' mfile '''); rmpath A25'];
        elseif n == 6
            com = ['addpath A25; read_NetCDF_OVIDE(''' PREFIX 'CTD/' DIR years{n} '/ovide_2010_CTDO2.nc'', ''35TH20100610'', ''' mfile '''); rmpath A25'];
        elseif n == 7
            com = ['addpath A25; read_ctd_exchange_2018(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath A25'];
        else
