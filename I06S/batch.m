...
for n = 1:length(years)
    ...
    if ~exist(mfile)
        if n == 1
            com = ['addpath I06S; read_ctd_exchange_1993(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath I06S'];
        elseif n == 4
            com = ['addpath I06S; read_ctd_exchange_2019(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath I06S'];
        else
