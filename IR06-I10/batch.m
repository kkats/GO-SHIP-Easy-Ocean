% variables
DIR = 'IR06-I10/';
BDIRs = {'../CTD/IR06/ir06', '../CTD/IR06/ir06', '../CTD/I10/i10', '../CTD/IR06/ir06', '../CTD/I10/i10'};
fname = 'ir06-i10';
...
for n = 1:length(years)
    ...
    if isempty(depth_files{n})
        com = ['D_reported(' num2str(n) ') = reported_data(''' DIR fname '_' years{n} '.list'',''' BDIRs{n} '_' years{n} '.mat'');'];
    else
        com = ['D_reported(' num2str(n) ') = reported_data(''' DIR fname '_' years{n} '.list'',''' BDIRs{n} '_' years{n} '.mat'', ''' depth_files{n} ''');'];
    end
    eval(com);
end
