...
DIR = 'SR04/';
fname = 'sr04';
years = {'1989', '1990', '1992', '1996', '1998', '2005', '2008', '2010'};
...
for n = 1:length(years)
    ...
    if ~exist(mfile)
        if n == 3
            com = ['addpath SR04; read_ctd_exchange_1992(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath SR04'];
        elseif n == 5
            com = ['addpath SR04; read_ctd_exchange_1998(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath SR04'];
        elseif n == 6 || n == 7
            com = ['addpath SR04; read_ctd_exchange_2005(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath SR04'];
        elseif n == 8
            com = ['addpath SR04; read_ctd_exchange_2010(''' PREFIX 'CTD/' DIR years{n} '/'', ''' mfile '''); rmpath SR04'];
        else
